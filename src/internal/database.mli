...
(** [read dir suffix reader key] reads information using [reader]. Data are
    supposed to reside in the files under [dir] directory with suffix [suffix].
